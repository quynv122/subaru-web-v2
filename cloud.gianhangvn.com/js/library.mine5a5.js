...
!(function (o, e) {
  "object" == typeof exports
    ...
    : (o.owlCarouselFilter = e(o.jQuery));
})(window, function (o, e) {
  "use strict";
  o.fn.owlCarouselFilter = function (o, e) {
    var l = this.data("owl.carousel").options;
    this.trigger("destroy.owl.carousel"),
      this.owlCarouselClone || (this.owlCarouselClone = this.clone());
    var t = this.owlCarouselClone.children(o).clone();
    this.empty().append(t).owlCarousel(l),
      this.trigger("filtered.owl.carousel");
  };
});
